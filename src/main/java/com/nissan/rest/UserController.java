...
public class UserController {
	...
	@GetMapping("user-list/{userName}&{password}")
	...
	/*
	@DeleteMapping(value = "users/{fullName}")
	public User deleteUser(@PathVariable String fullName ){
		System.out.println("Deleting a record");
		userService.deleteUser(fullName);
		 return userService.deleteUser(fullName);
	}
	*/
